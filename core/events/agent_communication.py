...
class MessageTemplates:
    ...
    @staticmethod
    def start_agent(
        sender: str, receiver: str, config: Dict[str, Any] = None
    ) -> Message:
        """启动智能体消息"""
    ...
    def status_request(sender: str, receiver: str) -> Message:
        ...
        return Message.create_request(
            sender=sender, receiver=receiver, request_type=MessageType.REQUEST_STATUS
        )
    ...
    def error_notification(
        sender: str, error_code: str, error_message: str, details: Dict[str, Any] = None
    ) -> Message:
        """错误通知消息"""
    ...
    @staticmethod
    def strategy_signal(
        sender: str, strategy_name: str, signal: Dict[str, Any]
    ) -> Message:
        """策略信号消息"""
        return Message.create_notification(
            sender=sender,
