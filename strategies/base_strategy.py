...
class BaseStrategy:
    ...
    def execute(self, market_data):
        ...
        try:
            ...
            # 记录执行结果
            self._log_execution(execution_id, "end", {
                "signal": signal,
            ...
            # 记录错误
            self._log_execution(execution_id, "error", {
                "error": str(e),
                "execution_time": f"{execution_time:.3f}s"
            })
    ...
    def set_params(self, params):
        ...
        self._log_execution("param_update", "params_updated", {
    ...
    def backtest(self, historical_data):
        ...
        self._log_execution("backtest", "backtest_started", {
    ...
    def _log_trade(self, trade_result):
        ...
        trade_log = {
            ...
            "strategy": self.name,
            "trade_id": trade_result.get("trade_id", f"trade_{int(time.time() * 1000)}"),
