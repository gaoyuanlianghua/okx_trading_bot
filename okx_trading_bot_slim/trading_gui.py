...
class TradingGUI(QMainWindow):
    ...
    def init_config_tab(self):
        ...
        api_form.addRow("Passphrase:", self.passphrase_edit)
        
        # API URL
        self.api_url_edit = QLineEdit("https://www.okx.com")
        ...
        api_form.addRow("超时时间(秒):", self.timeout_spin)
        
        # Environment
        self.env_combo = QComboBox()
        self.env_combo.addItems(["主网", "测试网"])
        api_form.addRow("环境:", self.env_combo)
        
        config_layout.addWidget(api_group)
        
        # Save button
        self.save_config_btn = QPushButton("保存配置")
        self.save_config_btn.setObjectName("primary")
